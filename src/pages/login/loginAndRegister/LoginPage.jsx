    ...
    return(
        <form onSubmit={handleSubmit}>
            <div className="img-div">
                <img class="login-img" src={StockWelcomeImage} alt="Stock Market Image"/>
                ...
                {<div id="login">
                    ...
                    {noExitingUser &&
                        <div className="field-not-valid"><p>Incorrect email or password. Please try again</p></div>}
                    <p id="actions">
                        <button type="button" className='LoginOrRegister' onClick={handleSwitch}>Create New User</button>
